...
describe('encode uri with customized values', () => {
  it('encode aes/gcm with customized values', () => {
    ...
    }).encoded).to.eql('encrypted:aes/gcm?iv=2345678wertyui&pad=ecb;en1e3kj3e31jn2algoritmgenerateddata')
  });
  ...
  it('encode salsa20 with customized values', () => {
    ...
    }).encoded).to.eql('encrypted:salsa20?no=871232183987132082713;en1e3kj3e31jn2algoritmgenerateddata')
  });
  ...
  it('encode xchacha with customized values', () => {
    ...
    }).encoded).to.eql('encrypted:xchacha?no=871232183987132082713;en1e3kj3e31jn2algoritmgenerateddata')
  });
  ...
  it('encode chacha12 with customized values', () => {
    ...
    }).encoded).to.eql('encrypted:chacha12?no=871232183987132082713;en1e3kj3e31jn2algoritmgenerateddata')
  });
});
